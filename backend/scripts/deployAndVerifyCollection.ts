...
async function main() {
  ...
  const MY_ADDRESS = "0x5f793abbd751f1ac5b0f95f3c3d117e5fd218c41";    //"0xFE2de2924c17C5A5E351E5fD13E2657836716BdD";
  /*
  ...
  */
  ...
  const waitFor = (delay: number) => new Promise(resolve => setTimeout(() => {
    hre.run("verify:verify", {
      ...
      constructorArguments: ["Wood Tables", "WTB", 40, "Wood Tables", MY_ADDRESS],
    })
  }, delay));
  await waitFor(60000);
